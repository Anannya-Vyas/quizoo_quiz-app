...
public class QuestionActivity6 extends AppCompatActivity {
    ...
    String[] questions = {
            "What is the correct return type of the main function in C?",
            "Which function is used to print output in C?",
            "How do you write a single-line comment in C (C99)?",
            "Which header file is required for input/output operations?",
            "How do you declare a pointer to an int in C?"
    };

    String[][] options = {
            {"int", "void", "char", "float", "main"},
            {"print()", "printf()", "cout", "Console.WriteLine()", "println()"},
            {"// comment", "/* comment */", "# comment", "-- comment", "<!-- comment -->"},
            {"<stdio.h>", "<iostream>", "<stdlib.h>", "<conio.h>", "<math.h>"},
            {"int* p;", "int p*;", "pointer int p;", "int &p;", "ptr int;"}
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener(v -> {
            ...
            if (ansText.equals(answers[flag])) {
                correct++;
                marks++;
                Toast.makeText(QuestionActivity6.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
                moveToNextQuestion();
            } else {
                wrong++;
                nextButton.setEnabled(false);
                Toast.makeText(QuestionActivity6.this, "Wrong Answer!\nCorrect is: " + answers[flag], Toast.LENGTH_LONG).show();
        ...
        skip.setOnClickListener(v -> {
            ...
            if (flag < questions.length) {
                ...
                Toast.makeText(QuestionActivity6.this, "Quiz Finished", Toast.LENGTH_SHORT).show();
