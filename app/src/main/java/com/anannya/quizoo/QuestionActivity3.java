...
public class QuestionActivity3 extends AppCompatActivity {
    ...
    String[] questions = {
            "What is the correct way to print in C++?",
            "Which is the correct declaration for a pointer to int?",
            "Which keyword is used to inherit a base class in C++?",
            "How do you comment a single line in C++?",
            "Which operator is used to access members of a structure via a pointer?"
    };

    String[][] options = {
            {"cout << \"Hello\";", "print(\"Hello\")", "Console.WriteLine()", "System.out.println()", "echo \"Hello\";"},
            {"int *p;", "int& p;", "int p*;", "pointer int;", "ptr int;"},
            {"public", "inherits", "extends", "implements", "base"},
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener(v -> {
            ...
            if (ansText.equals(answers[flag])) {
                correct++;
                marks++;
                Toast.makeText(QuestionActivity3.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
                moveToNextQuestion();
            } else {
                wrong++;
                nextButton.setEnabled(false);
                Toast.makeText(QuestionActivity3.this, "Wrong Answer!\nCorrect is: " + answers[flag], Toast.LENGTH_LONG).show();
        ...
        skip.setOnClickListener(v -> {
            ...
            if (flag < questions.length) {
                ...
                Toast.makeText(QuestionActivity3.this, "Quiz Finished", Toast.LENGTH_SHORT).show();
