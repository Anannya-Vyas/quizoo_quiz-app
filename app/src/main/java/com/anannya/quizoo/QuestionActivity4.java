...
public class QuestionActivity4 extends AppCompatActivity {
    ...
    String[] questions = {
            "What is the root element in a well-formed XML document?",
            "Which is a valid XML attribute syntax?",
            "How do you denote a self-closing tag in XML?",
            "What is the correct way to write a comment in XML?",
            "How do you declare an XML namespace?"
    };

    String[][] options = {
            {"<root>", "<xml>", "<document>", "<start>", "<begin>"},
            {"attribute=\"value\"", "attribute:value", "attribute=>value", "attribute value", "attribute==value"},
            {"<tag/>", "<tag>", "<tag></tag>", "<tag->", "<tag>>"},
            {"<!-- comment -->", "// comment", "# comment", "/* comment */", "<!-- comment //-->" },
            {"xmlns=\"namespace\"", "ns:=\"namespace\"", "namespace=\"xmlns\"", "declare=\"namespace\"", "ns-xmlns=\"namespace\""}
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener(v -> {
            ...
            if (ansText.equals(answers[flag])) {
                correct++;
                marks++;
                Toast.makeText(QuestionActivity4.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
                moveToNextQuestion();
            } else {
                wrong++;
                nextButton.setEnabled(false);
                Toast.makeText(QuestionActivity4.this, "Wrong Answer!\nCorrect is: " + answers[flag], Toast.LENGTH_LONG).show();
        ...
        skip.setOnClickListener(v -> {
            ...
            if (flag < questions.length) {
                ...
                Toast.makeText(QuestionActivity4.this, "Quiz Finished", Toast.LENGTH_SHORT).show();
