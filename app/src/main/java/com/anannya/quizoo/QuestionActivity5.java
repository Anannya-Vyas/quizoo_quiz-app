...
public class QuestionActivity5 extends AppCompatActivity {
    ...
    String[] questions = {
            "Which is a correct syntax to declare a variable in JavaScript?",
    ...
    String[][] options = {
            {"var x;", "int x;", "variable x;", "declare x;", "let x == 5;"},
            {"function myFunc() {}", "def myFunc() {}", "function:myFunc() {}", "func myFunc() {}", "function = myFunc() {}"},
            {"// comment", "# comment", "<!-- comment -->", "* comment", "-- comment"},
            {"getElementById()", "document.querySelector()", "document.getElementById()", "document.byId()", "select('#id')"},
            {"addEventListener()", "setEvent()", "onEvent()", "listenEvent()", "registerEvent()"}
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener(v -> {
            ...
            if (ansText.equals(answers[flag])) {
                correct++;
                marks++;
                Toast.makeText(QuestionActivity5.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
                moveToNextQuestion();
            } else {
                wrong++;
                nextButton.setEnabled(false);
                Toast.makeText(QuestionActivity5.this, "Wrong Answer!\nCorrect is: " + answers[flag], Toast.LENGTH_LONG).show();
        ...
        skip.setOnClickListener(v -> {
            ...
            if (flag < questions.length) {
                ...
                Toast.makeText(QuestionActivity5.this, "Quiz Finished", Toast.LENGTH_SHORT).show();
