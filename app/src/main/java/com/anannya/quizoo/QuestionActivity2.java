...
public class QuestionActivity2 extends AppCompatActivity {
    ...
    String[] questions = {
            "What data type is returned by the len() function in Python?",
    ...
    String[][] options = {
            ...
            {"//", "#", "/* */", "--", "%%"},
            {"A shorthand for loops", "A data type", "An error", "A function", "None of the above"},
            {"func", "def", "function", "fun", "lambda"},
            {"print(x)", "println(x)", "print(x, end=\"\")", "print.x()", "printf(x)"}
    };

    String[] answers = {
            "integer",
            "#",
            "A shorthand for loops",
            "def",
            "print(x, end=\"\")"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener(v -> {
            ...
            if (ansText.equals(answers[flag])) {
                correct++;
                marks++;
                Toast.makeText(QuestionActivity2.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
                moveToNextQuestion();
            } else {
                wrong++;
                nextButton.setEnabled(false);
                Toast.makeText(QuestionActivity2.this, "Wrong Answer!\nCorrect is: " + answers[flag], Toast.LENGTH_LONG).show();
        ...
        skip.setOnClickListener(v -> {
            ...
            if (flag < questions.length) {
                ...
                Toast.makeText(QuestionActivity2.this, "Quiz Finished", Toast.LENGTH_SHORT).show();
