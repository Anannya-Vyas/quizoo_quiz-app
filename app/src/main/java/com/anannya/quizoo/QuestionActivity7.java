...
public class QuestionActivity7 extends AppCompatActivity {
    ...
    String[] questions = {
            ...
            "Which SQL keyword is used to combine records from two tables?",
            "Which statement is used to insert new data?"
    };

    String[][] options = {
            {"SELECT", "GET", "FETCH", "RETRIEVE", "SHOW"},
            {"WHERE", "ORDER BY", "GROUP BY", "HAVING", "FILTER"},
            {"ORDER BY", "GROUP BY", "SORT BY", "HAVING", "ARRANGE BY"},
            {"JOIN", "MERGE", "COMBINE", "ATTACH", "CONCAT"},
            {"INSERT INTO", "ADD ROW", "NEW ROW", "APPEND", "INPUT"}
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener(v -> {
            ...
            if (ansText.equals(answers[flag])) {
                correct++;
                marks++;
                Toast.makeText(QuestionActivity7.this, "Correct Answer!", Toast.LENGTH_SHORT).show();
                moveToNextQuestion();
            } else {
                wrong++;
                nextButton.setEnabled(false);
                Toast.makeText(QuestionActivity7.this, "Wrong Answer!\nCorrect is: " + answers[flag], Toast.LENGTH_LONG).show();
        ...
        skip.setOnClickListener(v -> {
            ...
            if (flag < questions.length) {
                ...
                Toast.makeText(QuestionActivity7.this, "Quiz Finished", Toast.LENGTH_SHORT).show();
